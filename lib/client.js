...
function MemoryPanel({ sessionId, useSessions }) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: { padding: "12px 0" }, children: [
    error && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: { color: "var(--dsw-alias-state-error-primary)", marginBottom: 8 }, children: [
      "\u26A0 ",
      error
    ] }),
    notice && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: { color: "var(--dsw-alias-state-success-primary)", marginBottom: 8 }, children: [
      "\u2713 ",
      notice
    ] }),
    ...
    /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: { display: "flex", gap: 8, marginBottom: 10, alignItems: "center" }, children: [
      ...
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", { onClick: () => {
        ...
        setSelected(null);
      }, style: { padding: "6px 14px", ...btn }, children: "\uFF0B \u65B0\u5EFA" }),
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", { onClick: () => void runImport(), style: { padding: "6px 14px", ...btn }, children: "\u5BFC\u5165" })
    ] }),
    ...
    /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: { display: "flex", gap: 14, alignItems: "flex-start" }, children: [
      ...
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { style: { flex: 1.4, border, borderRadius: 8, padding: 12, minHeight: 300 }, children: editing ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("input", { value: editing.title, onChange: (e) => setEditing({ ...editing, title: e.target.value }), placeholder: "\u6807\u9898", style: { width: "100%", padding: 6, marginBottom: 8, borderRadius: 4, ...field } }),
        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: { display: "flex", gap: 8, marginBottom: 8 }, children: [
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("select", { value: editing.type, onChange: (e) => setEditing({ ...editing, type: e.target.value }), style: { padding: 6, borderRadius: 4, ...field }, children: TYPES.map((t) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("option", { value: t.value, children: t.label }, t.value)) }),
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("input", { value: (editing.tags ?? []).join(", "), onChange: (e) => setEditing({ ...editing, tags: e.target.value.split(",").map((s) => s.trim()).filter(Boolean) }), placeholder: "\u6807\u7B7E(\u9017\u53F7\u5206\u9694)", style: { flex: 1, padding: 6, borderRadius: 4, ...field } })
        ] }),
        editing.__new && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { style: { marginBottom: 8 }, children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("select", { value: editing.scope, onChange: (e) => setEditing({ ...editing, scope: e.target.value }), style: { padding: 6, borderRadius: 4, ...field }, children: [
        ...
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("textarea", { value: editing.content, onChange: (e) => setEditing({ ...editing, content: e.target.value }), placeholder: "\u5185\u5BB9(Markdown)", style: { width: "100%", height: 260, padding: 6, borderRadius: 4, ...field, fontFamily: "monospace", fontSize: 12 } }),
        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: { marginTop: 8, display: "flex", gap: 8 }, children: [
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", { onClick: () => void save(), style: { padding: "6px 16px", ...btn }, children: "\u4FDD\u5B58" }),
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", { onClick: () => setEditing(null), style: { padding: "6px 16px", ...btn }, children: "\u53D6\u6D88" })
        ] })
        ...
        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: muted, children: [
          ...
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { style: { fontSize: 11, color: "var(--dsw-alias-label-caption)" }, children: selected.path })
        ] }),
        ...
        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: { display: "flex", gap: 8 }, children: [
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", { onClick: () => setEditing({ ...selected }), style: { padding: "6px 16px", ...btn }, children: "\u7F16\u8F91" }),
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", { onClick: () => void remove(selected), style: { padding: "6px 16px", ...btn, color: "var(--dsw-alias-state-error-primary)" }, children: "\u5220\u9664" })
        ] })
...
function apply(ctx) {
  if (typeof document !== "undefined") {
    try {
      ...
      tag.textContent = "body[data-ds-dark-theme] input, body[data-ds-dark-theme] select, body[data-ds-dark-theme] textarea, body[data-ds-dark-theme] button { color-scheme: dark; }";
